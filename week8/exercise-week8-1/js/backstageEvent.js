 ...
 * @Last Modified time: 2016-05-11 17:18:45
 */
...
define(function(require, exports, module) {
    ...
    exports.deleteMySQL = function() {
        ...
        var delSQL = function(e) {
            ...
            var deldata = {
                ...
                // $.post("php/deleteMySQL.php", deldata);
            $.ajax({
                url: 'php/deleteMySQL.php',
                type: 'POST',
                data: deldata,
    ...
    exports.searchMySQL = function() {
            ...
            $(document).ready(function() {
                ...
                $('.btn-submit').on("click", function() {
                    $('.searchmysql-container').hide();
                    var newsclass = $('#classify-search').val();
                    var newsid = $('#newsid-search').val();
                    console.log(newsid);
                    var newstitle = $('#newstitle-search').val();
                    var newsimg = $('#newsimg-search').val();
                    var newscontent = $('#newscontent-search').val();
                    var newsaddtime = $('#newsaddtime-search').val();
                    var searchFormData = {
                        newsclass: newsclass,
                        newsid: newsid,
                        newstitle: newstitle,
    ...
    exports.modifyMySQL = function() {
            var modifyDiv = function(data) {
                ...
                $('#classify-mod option').each(function() {
                ...
                $('#newscontent-mod').html(newDB[0].newscontent);
                $('#newsaddtime-mod').attr({
